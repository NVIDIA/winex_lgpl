#ifndef __WINE_OLEACC_H_
#define __WINE_OLEACC_H_
...
#if 0 /* since we don't need this yet, I haven't bothered converting this stuff
         to wine-ised COM stuff yet.
       */
...
/* guids that were commented out for some reason ... */
...
typedef IAccessible* LPACCESSIBLE;
#endif /* end of transgaming if 0 */


/* function prototypes */
LRESULT WINAPI   LresultFromObject(REFIID riid, WPARAM wParam, LPUNKNOWN punk);
HRESULT WINAPI   ObjectFromLresult(LRESULT lResult, REFIID riid, WPARAM wParam, void** ppvObject);

HRESULT WINAPI   WindowFromAccessibleObject(IAccessible*, HWND* phwnd);
HRESULT WINAPI   AccessibleObjectFromWindow(HWND hwnd, DWORD dwId, REFIID riid, void **ppvObject);
HRESULT WINAPI   AccessibleObjectFromEvent(HWND hwnd, DWORD dwId, DWORD dwChildId, IAccessible** ppacc, VARIANT* pvarChild);

HRESULT WINAPI   AccessibleObjectFromPoint(POINT ptScreen, IAccessible ** ppacc, VARIANT* pvarChild);

HRESULT WINAPI   CreateStdAccessibleObject(HWND hwnd, LONG idObject, REFIID riid, void** ppvObject);
HRESULT WINAPI   AccessibleChildren (IAccessible* paccContainer, LONG iChildStart,
...
UINT WINAPI     GetStateTextA(DWORD lStateBit, LPSTR lpszState, UINT cchState);
UINT WINAPI     GetStateTextW(DWORD lStateBit, LPWSTR lpszState, UINT cchState);
#ifdef UNICODE
