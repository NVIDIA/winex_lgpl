...
#define IS_INTRESOURCE(i)   (!((ULONG_PTR)(i) >> 16))
...
#define RT_MANIFESTA           MAKEINTRESOURCEA(24)
#define RT_MANIFESTW           MAKEINTRESOURCEW(24)
#define RT_MANIFEST              WINELIB_NAME_AW(RT_MANIFEST)
...
/* Winuser redefines all the includes from pbt.h. */
...
#define VK_MBUTTON          0x04 /* Middle mouse button (3 button mice) */
...
#define VK_SNAPSHOT         0x2C /* SysRq/PrtScn starting in windows 3.0 */
...
/* Broadcast special message recipients */
...
/* Value returned to deny a query */
...
#define DBT_CONFIGCHANGECANCELED        0x00000019
#define DBT_CONFIGCHANGED               0x00000018
#define DBT_CUSTOMEVENT                 0x00008006
#define DBT_DEVICEARRIVAL               0x00008000
#define DBT_DEVICEQUERYREMOVE           0x00008001
#define DBT_DEVICEQUERYREMOVEFAILED     0x00008002
#define DBT_DEVICEREMOVECOMPLETE        0x00008004
#define DBT_DEVICEREMOVEPENDING         0x00008003
#define DBT_DEVICETYPESPECIFIC          0x00008005
#define DBT_DEVNODES_CHANGED            0x00000007
#define DBT_QUERYCHANGECONFIG           0x00000017
#define DBT_USERDEFINED                 0x0000FFFF
...
BOOL        WINAPI FlashWindowEx(FLASHWINFO *);
...
void WINAPI Sleep_SetState(BOOL state);
BOOL WINAPI Sleep_GetState(void);
void WINAPI Sleep_Poll(void);
