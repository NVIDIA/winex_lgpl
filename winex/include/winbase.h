...
/* defines for QueueUserWorkItem */
#define WT_EXECUTEDEFAULT            0
#define WT_EXECUTEINIOTHREAD         0x001
#define WT_EXECUTEINPERSISTENTTHREAD 0x080
#define WT_EXECUTELONGFUNCTION       0x010
