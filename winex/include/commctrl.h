...
/* if i(WIN32_IE >= 0x0400) */
#define ICC_INTERNET_CLASSES   0x00000800  /* IP address, ... */
#define ICC_PAGESCROLLER_CLASS 0x00001000  /* page scroller */
#define ICC_NATIVEFNTCTL_CLASS 0x00002000  /* native font control ???*/

/* if (_WIN32_WINT >= 0x501 ) */
#define ICC_LINK_CLASS         0x00008000  /* html link */
...
static const WCHAR WC_LINKW[] = {'S', 'y', 's', 'L', 'i', 'n', 'k', 0};
#define WC_LINK  WINELIB_NAME_AW(WC_LINK)
