...
#undef MIB_IPPROTO_OTHER
#undef MIB_IPPROTO_LOCAL
#undef MIB_IPPROTO_NETMGMT
#undef MIB_IPPROTO_ICMP
#undef MIB_IPPROTO_EGP
#undef MIB_IPPROTO_GGP
#undef MIB_IPPROTO_HELLO
#undef MIB_IPPROTO_RIP
#undef MIB_IPPROTO_IS_IS
#undef MIB_IPPROTO_ES_IS
#undef MIB_IPPROTO_CISCO
#undef MIB_IPPROTO_BBN
#undef MIB_IPPROTO_OSPF
#undef MIB_IPPROTO_BGP
#undef MIB_IPPROTO_NT_AUTOSTATIC    
#undef MIB_IPPROTO_NT_STATIC        
#undef MIB_IPPROTO_NT_STATIC_NON_DOD
