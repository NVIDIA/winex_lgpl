...
typedef enum _D3DBACKBUFFER_TYPE {
  ...
  D3DBACKBUFFER_FORCE_DWORD = 0x7fffffff
} D3DBACKBUFFER_TYPE;
...
#define D3DVSD_STREAM_TESS() D3DVSD_STREAM(D3DVSD_STREAMTESSMASK)
#define D3DVSD_REG(vertexRegister, regType) \
  (D3DVSD_MAKETOKENTYPE(D3DVSD_TOKEN_STREAMDATA) | ((regType) << D3DVSD_DATATYPESHIFT) | (vertexRegister))
#define D3DVSD_SKIP(skipCount) \
  (D3DVSD_MAKETOKENTYPE(D3DVSD_TOKEN_STREAMDATA) | D3DVSD_DATALOADTYPEMASK | ((skipCount) << D3DVSD_SKIPCOUNTSHIFT))
#define D3DVSD_CONST(constAddress, constCount) \
  (D3DVSD_MAKETOKENTYPE(D3DVSD_TOKEN_CONSTMEM) | ((constCount) << D3DVSD_CONSTCOUNTSHIFT) | (constAddress))
/* FIXME: D3DVSD_TESS* */
...
#define D3DVS_X_X (0<<(D3DVS_SWIZZLE_SHIFT+0))
#define D3DVS_X_Y (1<<(D3DVS_SWIZZLE_SHIFT+0))
#define D3DVS_X_Z (2<<(D3DVS_SWIZZLE_SHIFT+0))
#define D3DVS_X_W (3<<(D3DVS_SWIZZLE_SHIFT+0))
...
#define D3DPS_VERSION(vMajor,vMinor) (0xffff0000|((vMajor)<<8)|(vMinor))
#define D3DVS_VERSION(vMajor,vMinor) (0xfffe0000|((vMajor)<<8)|(vMinor))

#define D3DSHADER_VERSION_MAJOR(vVersion) (((vVersion)>>8)&0xff)
#define D3DSHADER_VERSION_MINOR(vVersion) (((vVersion)>>0)&0xff)
