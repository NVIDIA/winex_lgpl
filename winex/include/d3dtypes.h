...
public:
  ...
  D3DVALUE &operator () (int r, int c) { return ((D3DVALUE [4][4])&_11)[r][c]; }
  const D3DVALUE &operator () (int r, int c) const { return ((const D3DVALUE [4][4])&_11)[r][c]; }
  friend _D3DMATRIX operator * (const _D3DMATRIX& m1, const _D3DMATRIX& m2);
#endif
} D3DMATRIX;
