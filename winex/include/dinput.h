...
typedef WINELIB_NAME_AW(IDirectInputDevice2) *LPDIRECTINPUTDEVICE2;
...
typedef WINELIB_NAME_AW(IDirectInputDevice7) *LPDIRECTINPUTDEVICE7;
...
typedef WINELIB_NAME_AW(IDirectInputDevice8) *LPDIRECTINPUTDEVICE8;
...
/* PH: FIXME: #if DIRECTINPUT_VERSION <= 0x0700 */
...
/* PH: FIXME: #endif */ /* #if DIRECTINPUT_VERSION <= 0x0700 */
...
/* PH: FIXME: #else */ /* DIRECTINPUT_VERSION > 0x0700 */
 ...
 */
#define ICOM_INTERFACE IDirectInputDeviceW
#define IDirectInputDeviceW_METHODS \
    ICOM_METHOD1(HRESULT,GetCapabilities, LPDIDEVCAPS,lpDIDevCaps) \
    ICOM_METHOD3(HRESULT,EnumObjects, LPDIENUMDEVICEOBJECTSCALLBACKW,lpCallback, LPVOID,pvRef, DWORD,dwFlags) \
    ICOM_METHOD2(HRESULT,GetProperty, REFGUID,rguidProp, LPDIPROPHEADER,pdiph) \
    ICOM_METHOD2(HRESULT,SetProperty, REFGUID,rguidProp, LPCDIPROPHEADER,pdiph) \
    ICOM_METHOD (HRESULT,Acquire) \
    ICOM_METHOD (HRESULT,Unacquire) \
    ...
    ICOM_METHOD1(HRESULT,SetEventNotification, HANDLE,hEvent) \
    ICOM_METHOD2(HRESULT,SetCooperativeLevel, HWND,hwnd, DWORD,dwFlags) \
    ICOM_METHOD3(HRESULT,GetObjectInfo, LPDIDEVICEOBJECTINSTANCEW,pdidoi, DWORD,dwObj, DWORD,dwHow) \
    ICOM_METHOD1(HRESULT,GetDeviceInfo, LPDIDEVICEINSTANCEW,pdidi) \
    ICOM_METHOD2(HRESULT,RunControlPanel, HWND,hwndOwner, DWORD,dwFlags) \
    ICOM_METHOD3(HRESULT,Initialize, HINSTANCE,hinst, DWORD,dwVersion, REFGUID,rguid)
#define IDirectInputDeviceW_IMETHODS \
    IUnknown_IMETHODS \
 ...
 */
#define ICOM_INTERFACE IDirectInputDevice2W
#define IDirectInputDevice2W_METHODS \
    ICOM_METHOD4(HRESULT,CreateEffect, REFGUID,rguid, LPCDIEFFECT,lpeff, LPDIRECTINPUTEFFECT*,ppdeff, LPUNKNOWN,punkOuter) \
    ICOM_METHOD3(HRESULT,EnumEffects, LPDIENUMEFFECTSCALLBACKW,lpCallback, LPVOID,pvRef, DWORD,dwEffType) \
    ICOM_METHOD2(HRESULT,GetEffectInfo, LPDIEFFECTINFOW,pdei, REFGUID,rguid) \
    ICOM_METHOD1(HRESULT,GetForceFeedbackState, LPDWORD,pdwOut) \
    ICOM_METHOD1(HRESULT,SendForceFeedbackCommand, DWORD,dwFlags) \
    ICOM_METHOD3(HRESULT,EnumCreatedEffectObjects, LPDIENUMCREATEDEFFECTOBJECTSCALLBACK,lpCallback, LPVOID,pvRef, DWORD,fl) \
    ICOM_METHOD1(HRESULT,Escape, LPDIEFFESCAPE,pesc) \
    ICOM_METHOD (HRESULT,Poll) \
    ICOM_METHOD4(HRESULT,SendDeviceData, DWORD,cbObjectData, LPCDIDEVICEOBJECTDATA,rgdod, LPDWORD,pdwInOut, DWORD,fl)
#define IDirectInputDevice2W_IMETHODS \
    IDirectInputDeviceW_IMETHODS \
 ...
 */
#define ICOM_INTERFACE IDirectInputDevice7W
#define IDirectInputDevice7W_METHODS \
    ICOM_METHOD4(HRESULT,EnumEffectsInFile,LPCWSTR,lpszFileName,LPDIENUMEFFECTSINFILECALLBACK,pec,LPVOID,pvRef,DWORD,dwFlags) \
    ICOM_METHOD4(HRESULT,WriteEffectToFile,LPCWSTR,lpszFileName,DWORD,dwEntries,LPDIFILEEFFECT,rgDiFileEft,DWORD,dwFlags)
#define IDirectInputDevice7W_IMETHODS \
    IDirectInputDevice2W_IMETHODS \
 ...
 */
#define ICOM_INTERFACE IDirectInputDevice8W
#define IDirectInputDevice8W_METHODS \
    ICOM_METHOD3(HRESULT,BuildActionMap, LPDIACTIONFORMATW,lpdiaf, LPCWSTR,lpszUserName, DWORD,dwFlags) \
    ICOM_METHOD3(HRESULT,SetActionMap, LPDIACTIONFORMATW,lpdiaf, LPCWSTR,lpszUserName, DWORD,dwFlags) \
    ICOM_METHOD1(HRESULT,GetImageInfo, LPDIDEVICEIMAGEINFOHEADERW,lpdiDevImageInfoHeader)
#define IDirectInputDevice8W_IMETHODS \
    IDirectInputDevice7W_IMETHODS \
 ...
 */
#define ICOM_INTERFACE IDirectInputW
#define IDirectInputW_METHODS \
    ICOM_METHOD3(HRESULT,CreateDevice,    REFGUID,rguid, LPDIRECTINPUTDEVICEW*,lplpDirectInputDevice, LPUNKNOWN,pUnkOuter) \
    ICOM_METHOD4(HRESULT,EnumDevices,     DWORD,dwDevType, LPDIENUMDEVICESCALLBACKW,lpCallback, LPVOID,pvRef, DWORD,dwFlags) \
    ICOM_METHOD1(HRESULT,GetDeviceStatus, REFGUID,rguidInstance) \
    ICOM_METHOD2(HRESULT,RunControlPanel, HWND,hwndOwner, DWORD,dwFlags) \
    ICOM_METHOD2(HRESULT,Initialize,      HINSTANCE,hinst, DWORD,dwVersion)
#define IDirectInputW_IMETHODS \
    IUnknown_IMETHODS \
...
/*** IUnknown methods ***/
#define IDirectInput_QueryInterface(p,a,b) ICOM_CALL2(QueryInterface,p,a,b)
#define IDirectInput_AddRef(p)             ICOM_CALL (AddRef,p)
#define IDirectInput_Release(p)            ICOM_CALL (Release,p)
	/*** IDirectInput methods ***/
#define IDirectInput_CreateDevice(p,a,b,c)  ICOM_CALL3(CreateDevice,p,a,b,c)
#define IDirectInput_EnumDevices(p,a,b,c,d) ICOM_CALL4(EnumDevices,p,a,b,c,d)
#define IDirectInput_GetDeviceStatus(p,a)   ICOM_CALL1(GetDeviceStatus,p,a)
#define IDirectInput_RunControlPanel(p,a,b) ICOM_CALL2(RunControlPanel,p,a,b)
#define IDirectInput_Initialize(p,a,b)      ICOM_CALL2(Initialize,p,a,b)
 ...
 */
#define ICOM_INTERFACE IDirectInput2W
#define IDirectInput2W_METHODS \
    ICOM_METHOD3(HRESULT,FindDevice,      REFGUID,rguid, LPCWSTR,pszName, LPGUID,pguidInstance)
#define IDirectInput2W_IMETHODS \
    IDirectInputW_IMETHODS \
    IDirectInput2W_METHODS
ICOM_DEFINE(IDirectInput2W,IDirectInputW)
#undef ICOM_INTERFACE

/*** IUnknown methods ***/
#define IDirectInput2_QueryInterface(p,a,b) ICOM_CALL2(QueryInterface,p,a,b)
#define IDirectInput2_AddRef(p)             ICOM_CALL (AddRef,p)
#define IDirectInput2_Release(p)            ICOM_CALL (Release,p)
	/*** IDirectInput methods ***/
#define IDirectInput2_CreateDevice(p,a,b,c)  ICOM_CALL3(CreateDevice,p,a,b,c)
#define IDirectInput2_EnumDevices(p,a,b,c,d) ICOM_CALL4(EnumDevices,p,a,b,c,d)
#define IDirectInput2_GetDeviceStatus(p,a)   ICOM_CALL1(GetDeviceStatus,p,a)
#define IDirectInput2_RunControlPanel(p,a,b) ICOM_CALL2(RunControlPanel,p,a,b)
#define IDirectInput2_Initialize(p,a,b)      ICOM_CALL2(Initialize,p,a,b)
	/*** IDirectInput2 methods ***/
#define IDirectInput2_FindDevice(p,a,b,c)    ICOM_CALL3(FindDevice,p,a,b,c)
 ...
 */
#define ICOM_INTERFACE IDirectInput7W
#define IDirectInput7W_METHODS \
    ICOM_METHOD4(HRESULT,CreateDeviceEx,  REFGUID,rguid, REFIID,riid, LPVOID*,pvOut, LPUNKNOWN,lpUnknownOuter)
#define IDirectInput7W_IMETHODS \
    IDirectInput2W_IMETHODS \
    IDirectInput7W_METHODS
ICOM_DEFINE(IDirectInput7W,IDirectInput2W)
#undef ICOM_INTERFACE

/*** IUnknown methods ***/
#define IDirectInput7_QueryInterface(p,a,b) ICOM_CALL2(QueryInterface,p,a,b)
#define IDirectInput7_AddRef(p)             ICOM_CALL (AddRef,p)
#define IDirectInput7_Release(p)            ICOM_CALL (Release,p)
	/*** IDirectInput methods ***/
#define IDirectInput7_CreateDevice(p,a,b,c)  ICOM_CALL3(CreateDevice,p,a,b,c)
#define IDirectInput7_EnumDevices(p,a,b,c,d) ICOM_CALL4(EnumDevices,p,a,b,c,d)
#define IDirectInput7_GetDeviceStatus(p,a)   ICOM_CALL1(GetDeviceStatus,p,a)
#define IDirectInput7_RunControlPanel(p,a,b) ICOM_CALL2(RunControlPanel,p,a,b)
#define IDirectInput7_Initialize(p,a,b)      ICOM_CALL2(Initialize,p,a,b)
	/*** IDirectInput2 methods ***/
#define IDirectInput7_FindDevice(p,a,b,c)    ICOM_CALL3(FindDevice,p,a,b,c)
	/*** IDirectInput7 methods ***/
#define IDirectInput7_CreateDeviceEx(p,a,b,c,d) ICOM_CALL4(CreateDeviceEx,p,a,b,c,d)
#endif /* DI7 */
 ...
 */
#define ICOM_INTERFACE IDirectInput8W
#define IDirectInput8W_METHODS \
    ICOM_METHOD3(HRESULT,CreateDevice,    REFGUID,rguid, LPDIRECTINPUTDEVICE8W*,lplpDirectInputDevice, LPUNKNOWN,pUnkOuter) \
    ICOM_METHOD4(HRESULT,EnumDevices,     DWORD,dwDevType, LPDIENUMDEVICESCALLBACKW,lpCallback, LPVOID,pvRef, DWORD,dwFlags) \
    ICOM_METHOD1(HRESULT,GetDeviceStatus, REFGUID,rguidInstance) \
    ICOM_METHOD2(HRESULT,RunControlPanel, HWND,hwndOwner, DWORD,dwFlags) \
    ICOM_METHOD2(HRESULT,Initialize,      HINSTANCE,hinst, DWORD,dwVersion) \
    ICOM_METHOD3(HRESULT,FindDevice,      REFGUID,rguid, LPCWSTR,pszName, LPGUID,pguidInstance) \
    ICOM_METHOD5(HRESULT,EnumDevicesBySemantics, LPCWSTR,ptszUserName, LPDIACTIONFORMATW,lpdiActionFormat, LPDIENUMDEVICESBYSEMANTICSCBW,lpCallback, LPVOID,pvRef, DWORD,dwFlags) \
    ICOM_METHOD4(HRESULT,ConfigureDevices,LPDICONFIGUREDEVICESCALLBACK,lpdiCallback, LPDICONFIGUREDEVICESPARAMSW,lpdiCDParams, DWORD,dwFlags, LPVOID,pvRefData)
#define IDirectInput8W_IMETHODS \
    IUnknown_IMETHODS \
...
/*** IUnknown methods ***/
#define IDirectInput8_QueryInterface(p,a,b) ICOM_CALL2(QueryInterface,p,a,b)
#define IDirectInput8_AddRef(p)             ICOM_CALL (AddRef,p)
#define IDirectInput8_Release(p)            ICOM_CALL (Release,p)
	/*** IDirectInput8 methods ***/
#define IDirectInput8_CreateDevice(p,a,b,c)       ICOM_CALL3(CreateDevice,p,a,b,c)
#define IDirectInput8_EnumDevices(p,a,b,c,d)      ICOM_CALL4(EnumDevices,p,a,b,c,d)
#define IDirectInput8_GetDeviceStatus(p,a)        ICOM_CALL1(GetDeviceStatus,p,a)
#define IDirectInput8_RunControlPanel(p,a,b)      ICOM_CALL2(RunControlPanel,p,a,b)
#define IDirectInput8_Initialize(p,a,b)           ICOM_CALL2(Initialize,p,a,b)
#define IDirectInput8_FindDevice(p,a,b,c)         ICOM_CALL3(FindDevice,p,a,b,c)
#define IDirectInput8_EnumDevicesBySemantics(p,a,b,c,d,e) ICOM_CALL5(EnumDevicesBySemantics,p,a,b,c,d,e)
#define IDirectInput8_ConfigureDevices(p,a,b,c,d) ICOM_CALL4(ConfigureDevices,p,a,b,c,d)
#endif /* DI8 */
