...
extern BOOL WineEngGetCharABCWidth(GdiFont, UINT, UINT, LPABC);
extern BOOL WineEngGetCharABCWidthI(GdiFont, UINT, UINT, LPWORD, LPABC);
extern BOOL WineEngGetCharWidthI(GdiFont, UINT, UINT, LPWORD, LPINT);
extern BOOL WineEngGetCharWidth(GdiFont, UINT, UINT, LPINT);
extern DWORD WineEngGetFontData(GdiFont, DWORD, DWORD, LPVOID, DWORD);
extern DWORD WineEngGetGlyphIndices(GdiFont, LPCWSTR, INT, LPWORD, DWORD);
...
extern BOOL WineEngGetTextExtentPointI(GdiFont, LPWORD, INT, LPSIZE);
extern BOOL WineEngGetTextMetrics(GdiFont, LPTEXTMETRICW);
extern INT WineEngAddFontResourceEx(LPCWSTR str, DWORD fl, PVOID pv);
extern BOOL WineEngRemoveFontResourceEx(LPCWSTR str, DWORD fl, PVOID pv);
extern BOOL WineEngInit(void);
extern void WineEngFinalize(void);
