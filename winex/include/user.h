...
#define WINE_INTERNAL_SENT_INPUT_MOUSE    (32+INPUT_MOUSE)
#define WINE_INTERNAL_SENT_INPUT_KEYBOARD (32+INPUT_KEYBOARD)

#define LLKHF_SENT_INPUT 0x00000100
#define LLMHF_SENT_INPUT 0x00000100
...
typedef struct tagUSER_DRIVER {
    ...
    INT    (*pGetCharMessages)(UINT timestamp, INT *msg, USHORT *chars, UINT maxCount, UINT *actualCount);
    void   (*pBeep)(void);
    /* mouse functions */
    ...
    INT    (*pFlashWindow)(HWND, BOOL);
    BOOL   (*pIsExclusiveFullscreenWindow)(HWND);

    /* Display driver emergency exit */
    void   (*pDisplayEmergencyExit)(void);
