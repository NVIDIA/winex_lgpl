...
#ifndef __WINEX_D3DX9TEX_H
#define __WINEX_D3DX9TEX_H
...
/* FIXME!! These three function prototypes do not match the 
    D3DX9 headers from the DX SDK.  These functions are
    each supposed to take a pointer to a texture and a
    pointter to a compiled texture shader object as 
    parameteres.
    
    Commenting them out for now until they are needed or
    fixed.
*/
/*HRESULT WINAPI 
    D3DXFillTextureTX(
