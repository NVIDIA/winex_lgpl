/*
 * $Id: ptmalloc3.c,v 1.1 2006/10/26 13:55:21 mark Exp $
 * 
...
ptmalloc_init(void)
{
  ...
  if(TG_malloc_initialized >= 0) return;
  TG_malloc_initialized = 0;
