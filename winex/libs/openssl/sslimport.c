...
#  ifdef __APPLE__
static const char g_sslLibs[][LIB_NAME_LENGTH] = {  "OpenSSL.framework/openssl",
                                                    "libssl.1.0.0.dylib",
                                                    "libssl.0.9.9.dylib",
                                                    "libssl.0.9.8.dylib",
                                                    "libssl.0.9.7.dylib",
...
#  ifdef __APPLE__
static const char g_cryptoLibs[][LIB_NAME_LENGTH] = {   "OpenSSL.framework/crypto",
                                                        "libcrypto.1.0.0.dylib",
                                                        "libcrypto.0.9.9.dylib",
