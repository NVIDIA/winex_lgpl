...
{
    InitializeCriticalSection( &CoreAudio_crit );
    CRITICAL_SECTION_NAME( &CoreAudio_crit, "applemp3_CoreAudio" );
}
...
static LRESULT APPLEMP3_DriverDetails(PACMDRIVERDETAILSW add)
{
    ...
    MultiByteToWideChar( CP_ACP, 0, "Brought to you by TransGaming Technologies Inc...", -1,
                         add->szCopyright, sizeof(add->szCopyright)/sizeof(WCHAR) );
    MultiByteToWideChar( CP_ACP, 0, "Refer to TransGaming license information that came with your software product", -1,
