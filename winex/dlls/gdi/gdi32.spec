...
import	advapi32.dll
# can't both elf link and PE link. FIXME: need to seperate user
#import	kernel32.dll
#import	ntdll.dll
...
@ stdcall AddFontMemResourceEx(ptr long ptr long) AddFontMemResourceEx
...
@ stdcall GetCharABCWidthsI(long long long ptr ptr) GetCharABCWidthsI
...
@ stdcall GetCharWidthI(long long long ptr ptr) GetCharWidthI
...
@ stdcall GetGlyphIndicesA(long str long ptr long) GetGlyphIndicesA
@ stdcall GetGlyphIndicesW(long wstr long ptr long) GetGlyphIndicesW
...
@ stdcall RemoveFontMemResourceEx(long) RemoveFontMemResourceEx
