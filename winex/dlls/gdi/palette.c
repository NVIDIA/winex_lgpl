...
typedef HPALETTE (CALLBACK *SelectPalette_t)(HDC, HPALETTE, WORD);
typedef UINT (CALLBACK *RealizePalette_t)(HDC);

SelectPalette_t pfnSelectPalette = NULL;
RealizePalette_t pfnRealizePalette = NULL;
