...
/* _HlinkSimpleNavigateToString(): helper function to dynamically load and call out to the
     HlinkSimpleNavigateToString() function when needed.  This is done as a dynamically loaded
     function instead of using a delay loaded module in the spec file in order to break a
     circular module dependency between wininet and urlmon.  Without this, both modules will
     fail to build citing each other as being missing. */
static HRESULT WINAPI _HlinkSimpleNavigateToString(LPCWSTR               szTarget,
                                                   LPCWSTR               szLocation,
                                                   ...
                                                   DWORD                 dwReserved)
{
    typedef HRESULT (WINAPI *HlinkSimpleNavigateToString_Func)(LPCWSTR, LPCWSTR, LPCWSTR, IUnknown *, IBindCtx *, IBindStatusCallback *, DWORD, DWORD);
    static HlinkSimpleNavigateToString_Func func = NULL;
    ...
    if (func == NULL)
    {
        ...
        module = LoadLibraryA("urlmon");

        if (module == NULL)
            return E_NOTIMPL;

        func = (HlinkSimpleNavigateToString_Func)GetProcAddress(module, "HlinkSimpleNavigateToString");

        if (func == NULL)
            return E_NOTIMPL;
    }

    return func(szTarget, szLocation, szTargetFrameName, pUnk, pbc, pbsc, grfHLNF, dwReserved);
}
 ...
 LPARAM lp)
{
    ...
    case WM_COMMAND:
        ...
        case IDC_CPS:
        {
            ...
            _HlinkSimpleNavigateToString(cps, NULL, NULL, NULL, bctx, NULL,
        ...
        case IDC_ISSUERSTATEMENT:
        {
            ...
            if (issuerStatement)
            {
                ...
                else if (issuerStatement->cps)
                {
                    ...
                    CreateBindCtx(0, &bctx);
                    _HlinkSimpleNavigateToString(issuerStatement->cps, NULL,
 ...
 */
BOOL WINAPI CryptUIDlgViewContext(DWORD dwContextType, LPCVOID pvContext,
