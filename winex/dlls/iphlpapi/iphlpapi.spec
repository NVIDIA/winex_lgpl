...
@ stub Icmp6SendEcho2
@ forward IcmpCreateFile icmp.IcmpCreateFile
@ forward IcmpCloseHandle icmp.IcmpCloseHandle
@ forward IcmpParseReplies icmp.IcmpParseReplies
@ forward IcmpSendEcho icmp.IcmpSendEcho
@ forward IcmpSendEcho2 icmp.IcmpSendEcho2
@ stub IcmpSendEcho2Ex
