...
debug_channels (comm console debugstr dll int iocomp resource stress
                threadpool thunk toolhelp win32)
...
@ stdcall ActivateActCtx (long ptr) ActivateActCtx
...
@ stdcall CreateActCtxA (ptr) CreateActCtxA
@ stdcall CreateActCtxW (ptr) CreateActCtxW
...
@ stdcall CreateRemoteThread(long ptr long ptr long long ptr) CreateRemoteThread
...
@ stub CreateTimerQueueTimer
@ stdcall CreateToolhelp32Snapshot(long long) CreateToolhelp32Snapshot
@ stdcall DeactivateActCtx (long long) DeactivateActCtx
...
@ stdcall FoldStringA(long str long str long)
@ stdcall FoldStringW(long wstr long wstr long)
...
@ stdcall GetCPInfoExA(long long ptr) GetCPInfoExA
@ stdcall GetCPInfoExW(long long ptr) GetCPInfoExW
...
@ stdcall GetNativeSystemInfo(ptr) GetNativeSystemInfo
...
@ stdcall GetProcessId(long) GetProcessId
...
@ stdcall InitAtomTable(long) ATOM_InitAtomTable
...
@ stdcall IsWow64Process(long ptr) IsWow64Process
...
@ stdcall PostQueuedCompletionStatus(long long long ptr) PostQueuedCompletionStatus
...
@ stdcall ReleaseActCtx (long) ReleaseActCtx
...
@ stdcall Toolhelp32ReadProcessMemory(long ptr ptr long ptr) Toolhelp32ReadProcessMemory
...
@ stdcall GetProcessPriorityBoost(long ptr) GetProcessPriorityBoost
...
@ stdcall ReadDirectoryChangesW(ptr ptr long long long ptr ptr ptr) ReadDirectoryChangesW
...
@ forward SetCriticalSectionSpinCount ntdll.RtlSetCriticalSectionSpinCount
...
@ stdcall FindFirstVolumeA(str long)
@ stdcall FindFirstVolumeW(wstr long)
@ stdcall FindNextVolumeA(long str long)
@ stdcall FindNextVolumeW(long wstr long)
...
@ stdcall GetModuleHandleExA(long str ptr) GetModuleHandleExA
@ stdcall GetModuleHandleExW(long wstr ptr) GetModuleHandleExW
@ stdcall GetSystemWow64DirectoryA(str long) GetSystemWow64DirectoryA
@ stdcall GetSystemWow64DirectoryW(wstr long) GetSystemWow64DirectoryW
@ stdcall GetVolumePathNamesForVolumeNameA(str str long ptr)
@ stdcall GetVolumePathNamesForVolumeNameW(wstr wstr long ptr)
@ stdcall HeapSetInformation(long long long long) HeapSetInformation
@ forward InitializeSListHead ntdll.RtlInitializeSListHead
@ forward InterlockedFlushSList ntdll.RtlInterlockedFlushSList
@ forward InterlockedPopEntrySList ntdll.RtlInterlockedPopEntrySList
@ forward InterlockedPushEntrySList ntdll.RtlInterlockedPushEntrySList
@ forward QueryDepthSList ntdll.RtlQueryDepthSList

# XP SP2 extensions
@ stdcall EncodePointer(ptr) EncodePointer
@ stdcall DecodePointer(ptr) DecodePointer
@ stdcall EncodeSystemPointer(ptr) EncodeSystemPointer
@ stdcall DecodeSystemPointer(ptr) DecodeSystemPointer
