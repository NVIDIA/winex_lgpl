...
{
    TRACE("(hProcess = 0x%08x, hFile = 0x%08x, ImageName = '%s', ModuleName = '%s', BaseOfDll = 0x%08x, SizeOfDll = %u)\n",
                                ...
                                PMODLOAD_DATA Data, DWORD Flags)
{
    ...
    TRACE("(hProcess = 0x%08x, hFile = 0x%08x, ImageName = '%s', ModuleName = '%s', BaseOfDll = %s, DllSize = %u, Data = %p, Flags = 0x%08x)\n",
...
DWORD WINAPI SymGetModuleBase(HANDLE hProcess, DWORD dwAddr)
{
    ...
    TRACE("(hProcess = 0x%08x, dwAddr = 0x%08x)\n", hProcess, dwAddr);
