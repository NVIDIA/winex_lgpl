...
{
    /* 64 bit note: This will not work for 64-bit as the callback address is stored in the upper dword of the <user> or
       <data> parametres. */
    ...
    return cb32(hProcess, action, (PVOID)data32, (PVOID)(DWORD_PTR)user32);
}
