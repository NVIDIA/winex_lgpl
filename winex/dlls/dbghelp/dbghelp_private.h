...
/* dbghelp.c */
extern DWORD        g_minidumpTypeFlags;
extern BOOL         g_alwaysLoadLargePDBs;
...
extern DWORD64      normalize_addr64(DWORD64 addr);
...
/* mach_module.c */
struct MachMap;
extern struct module *  machLoadModule(struct process *pcs, const WCHAR *imageName, DWORD64 moduleBase, ULONG moduleSize);
extern BOOL             machLoadDebugInfo(struct process *pcs, struct module *module, struct MachMap *map);
...
extern BOOL         pe_load_nt_sect_header(HANDLE hProc, DWORD base, int i, IMAGE_NT_HEADERS *nt, 
