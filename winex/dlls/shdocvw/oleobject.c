...
/* shlwapi.dll - imported from WineHQ */
/*************************************************************************
 *      @       [SHLWAPI.165]
 *
 ...
 */
static LONG WINAPI SHSetWindowBits(HWND hwnd, INT offset, UINT wMask, UINT wFlags)
{
 ...
 */
static HWND WINAPI SHSetParentHwnd(HWND hWnd, HWND hWndParent)
{
  TRACE("%p, %p\n", hWnd, hWndParent);
