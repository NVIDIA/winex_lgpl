...
static const char * const SHELL_People[] =
{
    ...
    "Ross Biro",
    "Marco Bizzarri",
    "Dennis Bj\xcb\x86rklund",
    "David Black",
    "Zygo Blaxell",
    "Martin Boehme",
    "Francois Boisvert",
    "Pim Bollen",
    "Erik Inge Bols\xc2\xaf",
    "Mike Bond",
    "Uwe Bonnes",
    "Peter Bortas",
    "Noel Borthwick",
    ...
    "John Burton",
    "Jonathan Buzzard",
    "Vincent B\xc3\x88ron",
    "Brad Campbell",
    "Jose Marcos L\xc3\x9bpez Caravaca",
    "Michael Cardenas",
    "Eddie Carpenter",
    "Niels de Carpentier",
    "Mike Castle",
    ...
    "Stephane Lussier",
    "David Luyer",
    "Jos\xc3\x88 Marcos L\xc3\x9bpez",
    "Kenneth MacDonald",
    "Peter MacDonald",
    "Ondrej Macek",
    "Pierre Mageau",
