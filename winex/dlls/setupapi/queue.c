...
BOOL static do_file_copyW( LPCWSTR source, LPCWSTR target, DWORD style)
{
    ...
    if (style & (SP_COPY_NEWER_OR_SAME | SP_COPY_NEWER_ONLY | SP_COPY_FORCE_NEWER))
    {
        ...
        TRACE("SizeTarget %u ... SizeSource %u\n",VersionSizeTarget,
                VersionSizeSource);
        ...
        if (VersionSizeSource && VersionSizeTarget)
        {
            ...
            if (ret)
            {
                ...
                if (ret)
                {
                    TRACE("Versions: Source %u.%u target %u.%u\n",
                                        ...
                                        UINT_PTR param1, UINT_PTR param2 )
{
    ...
    case SPFILENOTIFY_ENDQUEUE:
        ...
        return 0;
    case SPFILENOTIFY_STARTSUBQUEUE:
        TRACE( "start subqueue %zd count %zd\n", param1, param2 );
        return TRUE;
    case SPFILENOTIFY_ENDSUBQUEUE:
        TRACE( "end subqueue %zd\n", param1 );
        return 0;
    case SPFILENOTIFY_STARTDELETE:
    ...
    case SPFILENOTIFY_NEEDMEDIA:
        ...
        return FILEOP_SKIP;
    default:
        FIXME( "notification %d params %tx,%tx\n", notification, param1, param2 );
        break;
    }
    return 0;
}
