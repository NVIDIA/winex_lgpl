...
void create_server_cs(void)
{
  ...
  CRITICAL_SECTION_NAME( &server_cs, "RpcServer" );

  InitializeCriticalSection( &listen_cs );
  CRITICAL_SECTION_NAME( &listen_cs, "RpcListen" );

  InitializeCriticalSection( &spacket_cs );
  CRITICAL_SECTION_NAME( &spacket_cs, "RpcServerPacket" );
