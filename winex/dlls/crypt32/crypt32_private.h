...
/* enable to write certificates to p_drive */
/*#define WRITE_CERTS_TO_PDRIVE*/

/* store debug propery ID */
#define CERT_STORE_DEBUG_NAME_PROP_ID 0x2000
...
#define CERTSTORE_FLAGS_DEFERING_CLOSE 0x00000001
