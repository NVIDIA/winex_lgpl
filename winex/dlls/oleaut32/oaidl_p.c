...
#define INCBUF(var,type) \
    (var) = (unsigned char *)((( type )(var)) + 1)
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *pctinfo = *(( UINT __RPC_FAR * )_StubMsg.Buffer);
            INCBUF (_StubMsg.Buffer, UINT __RPC_FAR *);
            _RetVal = *(( HRESULT __RPC_FAR * )_StubMsg.Buffer);
            INCBUF (_StubMsg.Buffer, HRESULT __RPC_FAR *);
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *(( LCID __RPC_FAR * )_StubMsg.Buffer) = lcid;
            INCBUF (_StubMsg.Buffer, LCID __RPC_FAR *);
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *(( DISPID __RPC_FAR * )_StubMsg.Buffer) = dispIdMember;
            INCBUF (_StubMsg.Buffer, DISPID __RPC_FAR *);
            ...
            *(( DWORD __RPC_FAR * )_StubMsg.Buffer) = dwFlags;
            INCBUF (_StubMsg.Buffer, DWORD __RPC_FAR *);
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *(( ULONG __RPC_FAR * )_StubMsg.Buffer) = celt;
            INCBUF (_StubMsg.Buffer, ULONG __RPC_FAR *);
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *(( WORD __RPC_FAR * )_StubMsg.Buffer) = wFlags;
            INCBUF (_StubMsg.Buffer, WORD __RPC_FAR *);
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *(( MEMBERID __RPC_FAR * )_StubMsg.Buffer) = memid;
            INCBUF (_StubMsg.Buffer, MEMBERID __RPC_FAR *);
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *pRefType = *(( HREFTYPE __RPC_FAR * )_StubMsg.Buffer);
            INCBUF (_StubMsg.Buffer, HREFTYPE __RPC_FAR *);
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *pImplTypeFlags = *(( INT __RPC_FAR * )_StubMsg.Buffer);
            INCBUF (_StubMsg.Buffer, INT __RPC_FAR *);
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *pfName = *(( BOOL __RPC_FAR * )_StubMsg.Buffer);
            INCBUF (_StubMsg.Buffer, BOOL __RPC_FAR *);
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *(( USHORT __RPC_FAR * )_StubMsg.Buffer) = *pcFound;
            INCBUF (_StubMsg.Buffer, USHORT __RPC_FAR *);
...
const USER_MARSHAL_ROUTINE_QUADRUPLE UserMarshalRoutines[3];
