...
static inline const PROV_ENUMALGS_EX* get_algid_info(HCRYPTPROV hProv, ALG_ID algid) {
    ...
    ERR("aiAlgid %x not found for provider %d\n", algid, pKeyContainer->dwPersonality);
                     ...
                     CONST PCRYPT_DATA_BLOB pblobSeed, PBYTE pbBuffer, DWORD dwBufferLen)
{
    ...
    TRACE("(hProv=%08tx, hSecret=%08tx, pblobLabel=%p, pblobSeed=%p, pbBuffer=%p, dwBufferLen=%d)\n",
                                ...
                                HCRYPTHASH *phHash)
{
    ...
    TRACE("(hProv=%08tx, Algid=%08x, hKey=%08tx, dwFlags=%08x, phHash=%p)\n", hProv, Algid, hKey,
          dwFlags, phHash);
                                   ...
                                   DWORD dwFlags, HCRYPTHASH *phHash)
{
    ...
    TRACE("(hUID=%08tx, hHash=%08tx, pdwReserved=%p, dwFlags=%08x, phHash=%p)\n", hUID, hHash,
                                  ...
                                  DWORD dwFlags, HCRYPTKEY *phKey)
{
    ...
    TRACE("(hUID=%08tx, hKey=%08tx, pdwReserved=%p, dwFlags=%08x, phKey=%p)\n", hUID, hKey,
                             ...
                             DWORD dwFlags, BYTE *pbData, DWORD *pdwDataLen, DWORD dwBufLen)
{
    ...
    TRACE("(hProv=%08tx, hKey=%08tx, hHash=%08tx, Final=%d, dwFlags=%08x, pbData=%p, "
                               ...
                               DWORD dwBlobType, DWORD dwFlags, BYTE *pbData, DWORD *pdwDataLen)
{
    ...
    TRACE("(hProv=%08tx, hKey=%08tx, hPubKey=%08tx, dwBlobType=%08x, dwFlags=%08x, pbData=%p,"
...
{
    TRACE("(hProv=%08tx, pbData=%p, dwDataLen=%d, hPubKey=%08tx, dwFlags=%08x, phKey=%p)\n",
...
BOOL WINAPI RSAENH_CPGenKey(HCRYPTPROV hProv, ALG_ID Algid, DWORD dwFlags, HCRYPTKEY *phKey)
{
    ...
    TRACE("(hProv=%08tx, aiAlgid=%d, dwFlags=%08x, phKey=%p)\n", hProv, Algid, dwFlags, phKey);
...
{
    TRACE("(hProv=%08tx, dwLen=%d, pbBuffer=%p)\n", hProv, dwLen, pbBuffer);
                                  ...
                                  DWORD *pdwDataLen, DWORD dwFlags) 
{
    ...
    TRACE("(hProv=%08tx, hHash=%08tx, dwParam=%08x, pbData=%p, pdwDataLen=%p, dwFlags=%08x)\n",
                                 ...
                                 DWORD dwFlags)
{
    ...
    TRACE("(hProv=%08tx, hKey=%08tx, dwParam=%08x, pbData=%p, dwFlags=%08x)\n", hProv, hKey,
                                 ...
                                 DWORD *pdwDataLen, DWORD dwFlags)
{
    ...
    TRACE("(hProv=%08tx, hKey=%08tx, dwParam=%08x, pbData=%p, pdwDataLen=%p dwFlags=%08x)\n",
                                  ...
                                  DWORD *pdwDataLen, DWORD dwFlags)
{
    ...
    TRACE("(hProv=%08tx, dwParam=%08x, pbData=%p, pdwDataLen=%p, dwFlags=%08x)\n",
                               ...
                               DWORD dwFlags, HCRYPTKEY *phKey)
{
    ...
    TRACE("(hProv=%08tx, Algid=%d, hBaseData=%08tx, dwFlags=%08x phKey=%p)\n", hProv, Algid,
...
BOOL WINAPI RSAENH_CPGetUserKey(HCRYPTPROV hProv, DWORD dwKeySpec, HCRYPTKEY *phUserKey)
{
    ...
    TRACE("(hProv=%08tx, dwKeySpec=%08x, phUserKey=%p)\n", hProv, dwKeySpec, phUserKey);
                              ...
                              DWORD dwDataLen, DWORD dwFlags)
{
    ...
    TRACE("(hProv=%08tx, hHash=%08tx, pbData=%p, dwDataLen=%d, dwFlags=%08x)\n",
                                    ...
                                    DWORD dwFlags)
{
    ...
    TRACE("(hProv=%08tx, hHash=%08tx, hKey=%08tx, dwFlags=%08x)\n", hProv, hHash, hKey, dwFlags);
                                  ...
                                  BYTE *pbData, DWORD dwFlags)
{
    ...
    TRACE("(hProv=%08tx, hHash=%08tx, dwParam=%08x, pbData=%p, dwFlags=%08x)\n",
                              ...
                              DWORD *pdwSigLen)
{
    ...
    TRACE("(hProv=%08tx, hHash=%08tx, dwKeySpec=%08x, sDescription=%s, dwFlags=%08x, "
                                     ...
                                     DWORD dwFlags)
{
    ...
    TRACE("(hProv=%08tx, hHash=%08tx, pbSignature=%p, dwSigLen=%d, hPubKey=%08tx, sDescription=%s, "
