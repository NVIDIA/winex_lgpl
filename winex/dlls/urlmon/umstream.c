                                  ...
                                  IUMCacheStream **ppstr)
{
    ...
    *c = 0;
    ...
    handle = CreateFileW( pszFileName, GENERIC_READ, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, CREATE_ALWAYS, 0, (HANDLE)NULL );
    ...
    if (phfile)
    {
        ...
        */
        *phfile = CreateFileW( pszFileName, GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, (HANDLE)NULL );
