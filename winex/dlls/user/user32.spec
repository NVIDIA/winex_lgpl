...
debug_channels (accel caret class clipboard combo comm cursor dc ddeml dialog
                ...
                string syscolor system text timer timestamp win win32 wnet)
...
@ stdcall EnumDisplayDevicesA(str long ptr long) EnumDisplayDevicesA
@ stdcall EnumDisplayDevicesW(wstr long ptr long) EnumDisplayDevicesW
...
@ stdcall FlashWindowEx(long) FlashWindowEx
...
@ stdcall ChangeDisplaySettingsW(ptr long) ChangeDisplaySettingsW
...
@ stdcall ChangeDisplaySettingsExW(str ptr long long ptr) ChangeDisplaySettingsExW
...
@ stdcall GetMenuBarInfo(long long long ptr) GetMenuBarInfo
@ stdcall GetScrollBarInfo(long long ptr) GetScrollBarInfo
@ stdcall GetTitleBarInfo(long ptr) GetTitleBarInfo
...
@ stdcall RegisterDeviceNotificationW(long ptr long) RegisterDeviceNotificationW
@ stdcall TrackMouseEvent(ptr) TrackMouseEvent
@ stdcall UnregisterDeviceNotification(long) UnregisterDeviceNotification
...
# win2k
@ stdcall UpdateLayeredWindow(long long ptr ptr long ptr long ptr long) UpdateLayeredWindow
...
#
@ stdcall Sleep_SetState(long) USER32_SetSleepState
@ stdcall Sleep_GetState() USER32_GetSleepState
@ stdcall Sleep_Poll() USER32_PollSleepState
...
@ stdcall DINPUT_ForceSetCursorPos(long long long) DINPUT_ForceSetCursorPos

@ cdecl DisplayEmergencyExit() DisplayEmergencyExit
