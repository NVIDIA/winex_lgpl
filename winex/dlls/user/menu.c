...
static void MENU_GetBitmapItemSize( UINT id, DWORD data, SIZE *size )
{
    ...
    if (id && IS_MAGIC_ITEM( id ))
    {
        ...
        case (DWORD_PTR)HBMMENU_SYSTEM:
            ...
            /* fall through */
        case (DWORD_PTR)HBMMENU_MBAR_RESTORE:
        case (DWORD_PTR)HBMMENU_MBAR_MINIMIZE:
        case (DWORD_PTR)HBMMENU_MBAR_MINIMIZE_D:
        case (DWORD_PTR)HBMMENU_MBAR_CLOSE:
        case (DWORD_PTR)HBMMENU_MBAR_CLOSE_D:
            size->cx = GetSystemMetrics( SM_CXSIZE );
            size->cy = GetSystemMetrics( SM_CYSIZE );
            return;
        case (WORD)HBMMENU_CALLBACK:
        case (DWORD_PTR)HBMMENU_POPUP_CLOSE:
        case (DWORD_PTR)HBMMENU_POPUP_RESTORE:
        case (DWORD_PTR)HBMMENU_POPUP_MAXIMIZE:
        case (DWORD_PTR)HBMMENU_POPUP_MINIMIZE:
        default:
